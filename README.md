...
Relocated 2026-07-04 from `etzhayyim/root/20-actors/bloomberg_law-compat` to
`kotoba-lang/com-bloomberg-law` per the org-taxonomy library-placement rule (any
